            ...
            <div className="mt-[40px] md:mt-[60px] relative flex justify-center items-center h-[350px] md:h-[450px] overflow-x-hidden md:overflow-visible">
                ...
                {loading ? (
                    <div className="relative z-10 flex items-center justify-center w-full h-full">
                        {/* Skeleton para las fotos laterales */}
                        <div className="absolute top-[20px] md:top-[35px] left-[-10%] md:left-[0%] lg:left-[5%] w-[180px] h-[180px] md:w-[400px] md:h-[400px] bg-white/5 animate-pulse" />
                        <div className="absolute top-[20px] md:top-[35px] right-[-10%] md:right-[0%] lg:right-[5%] w-[180px] h-[180px] md:w-[400px] md:h-[400px] bg-white/5 animate-pulse" />
                        {/* Skeleton para la central */}
                        <div className="relative z-30 w-[220px] h-[220px] md:w-[400px] md:h-[400px] bg-white/10 animate-pulse shadow-2xl" />
                    </div>
                ) : (
                    <>
