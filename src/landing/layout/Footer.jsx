...
const ActionButton = ({ href, children, icon: Icon }) => (
    <a 
        ...
        target="_blank" 
        rel="noreferrer"
        className="text-[11px] font-light transition-all duration-300 flex items-center gap-1.5 group py-0.5"
            ...
            >
                <div className="flex flex-col md:flex-row items-center p-10 md:p-14 gap-12 md:gap-0">
                    ...
                    <div className="flex-1 flex flex-col gap-8 pr-0 md:pr-12">
                        ...
                        {/* Tagline */}
                        <p className="text-white/60 text-[18px] md:text-[22px] leading-[1.4] font-light tracking-tight max-w-[400px]">
                        ...
                        {/* Copyright */}
                        <div>
                            <p className="text-[10px] font-light tracking-widest uppercase opacity-10">
                    ...
                    <div className="flex-1 flex flex-col md:flex-row px-0 md:px-12 gap-8 md:gap-0">
                        ...
                        <div className="flex-1 flex flex-col gap-1.5">
                            <p className="text-[11px] font-medium text-white/5 mb-3">Páginas</p>
                        ...
                        {/* Oficial */}
                        <div className="flex-1 flex flex-col gap-1.5">
                            <p className="text-[11px] font-medium text-white/5 mb-3">Oficial</p>
                    ...
                    {/* ── COLUMNA DERECHA (Streaming como íconos sociales) ── */}
