...
const NavLink = ({ to, href, children, external }) => {
    const cls = "text-[15px] font-normal transition-colors duration-200 block py-1.5";
    const style = { color: "rgba(255,255,255,0.5)" };
    const hover = e => e.currentTarget.style.color = "#ffffff";
    const leave = e => e.currentTarget.style.color = "rgba(255,255,255,0.5)";
            ...
            >
                <div className="flex flex-col md:flex-row p-10 md:p-14 gap-0">
                    ...
                    <div className="flex-1 flex flex-col gap-10 pr-0 md:pr-12">
                        {/* Texto Myke Towers / Young King (Sin Logo) */}
                        <div className="flex flex-col leading-tight">
                            <span className="text-white text-[18px] font-bold tracking-tight">Myke Towers</span>
                            <span className="text-white/40 text-[16px] font-light italic">Young King</span>
                        </div>

                        {/* Tagline de Desarrollo */}
                        <h3 className="text-white text-[24px] md:text-[28px] leading-[1.3] font-medium tracking-tight">
                            Este proyecto fue con fines de desarrollo web y fue diseñado por Sebastian.
                        </h3>

                        {/* Links de GitHub / Repositorio */}
                    ...
                    {/* ── COLUMNAS CENTRALES (Navegación & Música) ── */}
                    <div className="flex-1 flex flex-col md:flex-row px-0 md:px-12 py-10 md:py-0">
                        <div className="flex-1 flex flex-col gap-2">
                            ...
                            <NavLink href="https://sebas-dev.vercel.app/" external>Portfolio Dev</NavLink>
                        </div>
                        <div className="flex-1 flex flex-col gap-2 mt-6 md:mt-0">
                            ...
                            <NavLink href="https://tiktok.com/@myketowers" external>TikTok</NavLink>
                        </div>
                    </div>
