...
export const Bg = () => {
    return (
        <section className="fixed top-0 left-0 w-full h-screen">
            {/* CIRCLE GREEN */}
            <div className="absolute w-[13vw] h-[13vw] bg-[var(--green)] rounded-full blur-[140px] opacity-80"></div>
            {/* CIRCLE white */}
            <div className="absolute left-[0%] bottom-[20%] w-[8vw] h-[8vw] bg-white/70 rounded-full blur-[80px] opacity-60"></div>
            {/* CIRCLE BLUE */}
