                ...
                >
                    ...
                    <div className="flex flex-wrap justify-center gap-3">
                        <a 
                            ...
                            className="group flex items-center gap-2.5 px-5 py-3 bg-white/5 border border-white/10 hover:bg-white/[0.08] hover:border-white/20 text-white/70 hover:text-white rounded-lg transition-all duration-300 text-[12px] font-mono tracking-wide google-sans-code-api"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group flex items-center gap-2.5 px-5 py-3 bg-[var(--blue)]/10 border border-[var(--blue)]/20 hover:bg-[var(--blue)]/20 hover:border-[var(--blue)]/40 text-white/70 hover:text-white rounded-lg transition-all duration-300 text-[12px] font-mono tracking-wide google-sans-code-api"
                        >
