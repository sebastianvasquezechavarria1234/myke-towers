                ...
                >
                    ...
                    <div className="flex flex-wrap justify-center gap-6">
                        ...
                        >
                            ...
                            <span className="underline underline-offset-4 decoration-transparent hover:decoration-white/60 transition-all duration-150">Repositorio</span>
                        ...
                        >
                            <Server size={14} />
                            <span className="underline underline-offset-4 decoration-transparent hover:decoration-white/60 transition-all duration-150">API <span className="text-white/30">—</span> myke-towers-api.onrender.com</span>
                            <ExternalLink size={12} />
                        </a>
                    </div>
                </motion.div>
